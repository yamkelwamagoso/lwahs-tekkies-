...
.nav a{margin:4px;color:#ff1493;text-decoration:none;font-weight:bold;font-size:13px}
...
<div class="header"><div class="logo">💖 Lwah's Tekkies</div><div class="nav"><a href="/">🏠 Shop</a> <a href="#" onclick="checkoutWA()">🛒(<span id="cartCount">0</span>)</a></div></div>
<div class="banner"><h3 style="margin:0">Step Out. Stand Out. 👑</h3><p style="margin:3px;font-size:13px">Durban | WhatsApp: 081 566 6133</p></div>
<div class="products">
{% for p in products %}
<div class="card">
...
</head><body><h2 style="color:#ff1493">💖 Lwah Secret Admin</h2>
...
<button class="btn" type="submit">Upload 👑</button></form><br><a href="/">← Back to Shop</a></body></html>"""
